...
lcd.setCursor(1,3);
 ...
 lcd.print("Distance: ");
  lcd.print(getSonar()); // Send ping, get distance in cm and print result (0 = outside set distance range)
  lcd.println("m");
...
float getSonar() {
  ...
  distance = (float)pingTime * soundVelocity / 2 /1000000 ; // calculate the distance according to the time
